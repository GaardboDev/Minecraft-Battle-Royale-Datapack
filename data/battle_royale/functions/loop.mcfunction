...
#Hold Spectators players at 0 100 0
tp @a[x=0,y=100,z=0,tag=Joined,gamemode=spectator,distance=10..] 0 100 0
tp @a[x=0,y=100,z=0,tag=Dead,gamemode=spectator,distance=10..] 0 100 0
